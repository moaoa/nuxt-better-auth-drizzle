...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    NOWPAYMENTS_API_KEY: process.env.NUXT_NOWPAYMENTS_API_KEY,
    NOWPAYMENTS_IPN_SECRET: process.env.NUXT_NOWPAYMENTS_IPN_SECRET,
    NOWPAYMENTS_BASE_URL: process.env.NUXT_NOWPAYMENTS_BASE_URL,
